locals {
  ...
  lambda04_class_name = "com.roberto.aws.lambda.FunctionDynamoEvent"
}
...
module "dlq" {
  ...
  destination_lambda_arn = module.lambda_dynamo_source.lambda_function_arn
  lab_role_arn           = var.lab_role_arn
}
